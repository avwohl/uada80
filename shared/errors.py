...
class ErrorCollector:
    ...
    def error(self, message: str, location: SourceLocation | None = None) -> None:
        """Create and add a generic error."""
        self.add_error(CompilerError(message, location))

    def warning(self, message: str, location: SourceLocation | None = None) -> None:
        """Create and add a warning."""
        self.add_warning(CompilerWarning(message, location))
