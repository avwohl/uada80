...
class Z80CodeGen:
    ...
    def generate(self, module: IRModule) -> str:
        ...
        # Generate 48-bit floating point runtime (z88dk math48 compatible)
        self._generate_float48_runtime()

        # Generate tasking runtime
        self._generate_tasking_runtime()

        # Generate C interface support runtime
        self._generate_c_interface_runtime()

        # Generate container runtime
        self._generate_container_runtime()

        # Generate stream I/O runtime
        self._generate_stream_runtime()

        # External declarations for z88dk math48 library
        self._generate_float48_externals()

        # External declarations for libada.lib runtime library
