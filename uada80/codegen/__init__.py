...
class Z80CodeGen:
    ...
    def _generate_string_runtime(self) -> None:
        ...
        # _memcmp: Compare two memory regions byte-by-byte
        self._emit("; _memcmp: Compare two memory blocks")
        self._emit("; Input: Stack: ptr1 (ix+8), ptr2 (ix+6), size (ix+4)")
        self._emit("; Output: hl = 0 if equal, nonzero if different")
        self._emit("_memcmp:")
        self._emit("    push ix")
        self._emit("    ld ix, 0")
        self._emit("    add ix, sp")
        self._emit("    push bc")
        self._emit("    ; HL = ptr1, DE = ptr2, BC = size")
        self._emit("    ld l, (ix+8)")
        self._emit("    ld h, (ix+9)")
        ...
        self._emit("    ld a, b")
        self._emit("    or c")
        self._emit("    jr z, _memcmp_eq")
        self._emit("_memcmp_lp:")
        self._emit("    ld a, (hl)")
        self._emit("    push hl")
        self._emit("    ex de, hl")
        self._emit("    cp (hl)")
        self._emit("    ex de, hl")
        self._emit("    pop hl")
        self._emit("    jr nz, _memcmp_ne")
        self._emit("    inc hl")
        self._emit("    inc de")
        self._emit("    dec bc")
        self._emit("    ld a, b")
        self._emit("    or c")
        self._emit("    jr nz, _memcmp_lp")
        self._emit("_memcmp_eq:")
        self._emit("    ld hl, 0")
        self._emit("    jr _memcmp_dn")
        self._emit("_memcmp_ne:")
        self._emit("    ld hl, 1")
        self._emit("_memcmp_dn:")
        self._emit("    pop bc")
        self._emit("    pop ix")
        self._emit("    ret")
        self._emit("")
    ...
    def _generate_math_runtime(self) -> None:
        ...
        self._emit("; If signs differ and remainder != 0: result = divisor - remainder")
        self._emit("; Otherwise result has sign of divisor applied to |remainder|")
        self._emit("_mod16:")
        self._emit("    push bc")
        self._emit("    ; Save original divisor sign and combined sign")
        self._emit("    ld a, h")
        self._emit("    xor d")
        self._emit("    ld c, a       ; C = combined sign (bit 7 = signs differ)")
        self._emit("    ld a, d")
        self._emit("    ld b, a       ; B = divisor sign (bit 7 = negative)")
        self._emit("    push bc       ; save both signs")
        self._emit("    push de       ; save original divisor for adjustment")
        self._emit("    ; Make both positive for unsigned division")
        self._emit("    bit 7, h")
        ...
        self._emit("    ; Unsigned divide: hl/de, remainder in bc")
        self._emit("    call _div16_unsigned")
        self._emit("    ld h, b")
        self._emit("    ld l, c       ; hl = |remainder|")
        self._emit("    ; If remainder is zero, result is zero")
        self._emit("    ld a, h")
        self._emit("    or l")
        self._emit("    jr z, _mod16_zero")
        self._emit("    ; Remainder != 0: check if signs differed")
        self._emit("    pop de        ; de = original divisor")
        self._emit("    pop bc        ; B = divisor sign, C = combined sign")
        self._emit("    bit 7, c")
        self._emit("    jr z, _mod16_same_sign")
        self._emit("    ; Signs differed: result = divisor + (-remainder) = divisor - |rem|")
        self._emit("    ; Use original signed divisor")
        self._emit("    ex de, hl     ; de = |remainder|, hl = original divisor")
        self._emit("    ; divisor is signed, need |divisor| - |remainder|")
        self._emit("    ; then apply divisor sign")
        self._emit("    bit 7, h")
        self._emit("    jr z, _mod16_div_pos")
        self._emit("    ; Negate hl to get |divisor|")
        self._emit("    xor a")
        self._emit("    sub l")
        self._emit("    ld l, a")
        self._emit("    sbc a, a")
        self._emit("    sub h")
        self._emit("    ld h, a")
        self._emit("_mod16_div_pos:")
        self._emit("    ; hl = |divisor|, de = |remainder|")
        self._emit("    or a")
        self._emit("    sbc hl, de    ; hl = |divisor| - |remainder|")
        self._emit("    ; Apply divisor's sign")
        self._emit("    bit 7, b")
        self._emit("    jr z, _mod16_ret")
        self._emit("    ; Negate: divisor was negative")
        self._emit("    xor a")
        self._emit("    sub l")
        self._emit("    ld l, a")
        self._emit("    sbc a, a")
        ...
        self._emit("_mod16_same_sign:")
        self._emit("    ; Same signs: result = |remainder| with divisor's sign")
        self._emit("    bit 7, b")
        self._emit("    jr z, _mod16_ret")
        self._emit("    ; Negate: divisor was negative")
        self._emit("    xor a")
        ...
        self._emit("    ld h, a")
        self._emit("    jr _mod16_ret")
        self._emit("_mod16_zero:")
        self._emit("    pop de        ; discard saved divisor")
        self._emit("    pop bc        ; discard saved signs")
    ...
    def _generate_function(self, func: IRFunction) -> None:
        ...
        # Handle forwarding stubs (subprogram renamings)
        if func.forwarding_target:
            mangled_name = self._mangle_symbol(func.name)
            target_name = self._mangle_symbol(func.forwarding_target)
            self._emit(f"; Renaming stub: {func.name} -> {func.forwarding_target}")
            self._emit(f"{mangled_name}:")
            self._emit_instr("jp", target_name)
            self._emit("")
            return
