...
package body System.Pack_11 is
   ...
   is
      Bit_Offset : constant Natural := N * 11;
   ...
   begin
      ...
      if Bit_Pos > 5 then
         ...
         begin
            Val := Val + Natural (B3 mod (2 ** (Bit_Pos + 11 - 16))) * 256;
         end;
      end if;

      return Bits_11 (Val mod 2048);
   end Get_11;
   ...
   begin
      ...
      if Bit_Pos > 5 then
         ...
         begin
            B3 := (B3 and not Cluster (2 ** (Bit_Pos + 11 - 16) - 1)) or
                  Cluster (V / 256);
