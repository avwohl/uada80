-- Ada.Wide_Characters.Unicode body for Z80
...
package body Ada.Wide_Characters.Unicode is
   ...
   function Get_Category (Item : Wide_Character) return General_Category is
      Code : constant Integer := Wide_Character'Pos (Item);
   begin
      -- Basic ASCII and Latin-1 range
   ...
   function Is_Number (Item : Wide_Character) return Boolean is
      Cat : constant General_Category := Get_Category (Item);
   begin
   ...
   function Is_Punctuation (Item : Wide_Character) return Boolean is
      Cat : constant General_Category := Get_Category (Item);
   begin
   ...
   function Is_Symbol (Item : Wide_Character) return Boolean is
      Cat : constant General_Category := Get_Category (Item);
   begin
   ...
   function Is_Separator (Item : Wide_Character) return Boolean is
      Cat : constant General_Category := Get_Category (Item);
   begin
   ...
   function Is_Other (Item : Wide_Character) return Boolean is
      Cat : constant General_Category := Get_Category (Item);
   begin
   ...
   function Is_Line_Break (Item : Wide_Character) return Boolean is
      Code : constant Integer := Wide_Character'Pos (Item);
   begin
      return Code = 16#0A# or Code = 16#0D# or Code = 16#85#;
   end Is_Line_Break;
   ...
   function Is_Non_Graphic (Item : Wide_Character) return Boolean is
      Cat : constant General_Category := Get_Category (Item);
   begin
