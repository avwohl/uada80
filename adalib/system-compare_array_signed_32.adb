-- System.Compare_Array_Signed_32 body for Z80
...
package body System.Compare_Array_Signed_32 is
   ...
   is
      type S32_Ptr is access all Signed_32;
      for S32_Ptr'Storage_Size use 0;

      function To_Ptr is new Ada.Unchecked_Conversion (System.Address, S32_Ptr);

      Min_Len : constant Natural := Natural'Min (Left_Len, Right_Len);
      L_Val, R_Val : Signed_32;
   begin
