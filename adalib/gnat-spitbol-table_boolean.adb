-- GNAT.Spitbol.Table_Boolean body for Z80
-- SPITBOL boolean table implementation

package body GNAT.Spitbol.Table_Boolean is
   ...
   function Get (T : Table; Key : String) return Boolean is
   ...
   procedure Set (T : in Out Table; Key : String; Value : Boolean) is
