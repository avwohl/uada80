-- Ada.Strings.Wide_Wide_Bounded for Z80
-- Bounded-length wide wide string handling
--
-- Provides generic bounded wide wide strings with compile-time maximum length.
...
package Ada.Strings.Wide_Wide_Bounded is
   ...
   function To_Wide_Wide_String (Source : Bounded_Wide_Wide_String) return Wide_Wide_String;
   ...
   function "="  (Left : Bounded_Wide_Wide_String; Right : Wide_Wide_String) return Boolean;
   function "="  (Left : Wide_Wide_String; Right : Bounded_Wide_Wide_String) return Boolean;
...
private
   ...
   type Bounded_Wide_Wide_String is record
      Data   : Wide_Wide_String (1 .. Max_Length);
      Length : Length_Range := 0;
   end record;

   Null_Bounded_Wide_Wide_String : constant Bounded_Wide_Wide_String :=
     (Data => (others => Wide_Wide_Character'Val (32)), Length => 0);
