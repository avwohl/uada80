...
package body System.Pack_13 is
   ...
   is
      Bit_Offset : constant Natural := N * 13;
   ...
   begin
      ...
      if Bit_Pos > 3 then
         ...
         begin
            Val := Val + Natural (B3 mod (2 ** (Bit_Pos + 13 - 16))) * 256;
         end;
      end if;

      return Bits_13 (Val mod 8192);
   end Get_13;
   ...
   begin
      ...
      if Bit_Pos > 3 then
         ...
         begin
            B3 := (B3 and not Cluster (2 ** (Bit_Pos + 13 - 16) - 1)) or
                  Cluster (V / 256);
