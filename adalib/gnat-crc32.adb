-- GNAT.CRC32 body for Z80
-- CRC-32 checksum computation implementation

package body GNAT.CRC32 is

   -- CRC-32 polynomial table (standard IEEE 802.3)
   -- Table precomputed for polynomial 0xEDB88320
   Table : constant array (0 .. 255) of Interfaces.Unsigned_32 := (
      ...
      16#21B4F4B5#, 16#56B3C423#, 16#CFB A9599#, 16#B8BDA50F#,
   ...
   procedure Update (C : in Out CRC32; S : String) is
   begin
   ...
   procedure Update (C : in Out CRC32; Ch : Character) is
      use Interfaces;
      Index : Unsigned_32;
   begin
      Index := (Unsigned_32 (C) xor Character'Pos (Ch)) and 16#FF#;
      C := CRC32 (Table (Natural (Index)) xor
                  Shift_Right (Unsigned_32 (C), 8));
   end Update;
   ...
   function Get_Value (C : CRC32) return Interfaces.Unsigned_32 is
      use Interfaces;
   begin
      return Unsigned_32 (C) xor 16#FFFFFFFF#;
   end Get_Value;
