-- Ada.Containers.Bounded_Vectors body for Z80
-- Generic bounded vector implementation
...
package body Ada.Containers.Bounded_Vectors is
   ...
   begin
      ...
      if New_Last > Index_Type'First + Index_Type'Base (Container.Capacity) - 1 then
