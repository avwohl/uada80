...
package body System.Pack_14 is
   ...
   is
      Bit_Offset : constant Natural := N * 14;
   ...
   begin
      ...
      if Bit_Pos > 2 then
         ...
         begin
            Val := Val + Natural (B3 mod (2 ** (Bit_Pos + 14 - 16))) * 256;
         end;
      end if;

      return Bits_14 (Val mod 16384);
   end Get_14;
   ...
   begin
      ...
      if Bit_Pos > 2 then
         ...
         begin
            B3 := (B3 and not Cluster (2 ** (Bit_Pos + 14 - 16) - 1)) or
                  Cluster (V / 256);
