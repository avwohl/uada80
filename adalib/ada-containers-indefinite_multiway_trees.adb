-- Ada.Containers.Indefinite_Multiway_Trees body for Z80
-- Generic multiway tree for indefinite element types implementation
...
package body Ada.Containers.Indefinite_Multiway_Trees is
   ...
   is
      ...
      begin
         ...
         if Container.Nodes (N).Element /= null and then
            Container.Nodes (N).Element.all = Item
         then
