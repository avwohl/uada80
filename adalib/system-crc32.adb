...
package body System.CRC32 is
   ...
   is
      Index : constant Natural :=
        Natural ((CRC xor CRC32_Value (Character'Pos (Data))) and 16#FF#);
   begin
      return CRC_Table (Index) xor (CRC / 256);
   end Update;
   ...
   function Finalize (CRC : CRC32_Value) return CRC32_Value is
   begin
   ...
   function CRC32 (Data : String) return CRC32_Value is
   begin
      return Finalize (Update (Initial_CRC, Data));
   end CRC32;
